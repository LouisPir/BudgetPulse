const en: Record<string, string> = {
  ...
  'settings.reimbursements': 'Reimbursements',
  'settings.pendingReimbursements': 'Pending',
  'settings.reimbursementProfiles': 'Profiles',
  'transaction.reimbursement.reimbursed': 'Reimbursed',
  'export.title': 'PDF Export',
  'export.preview': 'PDF Preview',
  'export.transactions': 'Transactions',
  'export.empty': 'No transactions this month',
  'export.button': 'Export as PDF',
  'settings.export': 'PDF Export',
  'reimbursement.title': 'Reimbursements',
  'reimbursement.total': 'Total pending',
  'reimbursement.empty': 'All reimbursed!',
  'reimbursement.emptySubtitle': 'No pending reimbursements.',
  'reimbursement.markTitle': 'Mark as reimbursed',
  'reimbursement.markConfirm': 'Mark this transaction as reimbursed?',
  'reimbursement.mark': 'Reimbursed ✓',
  'reimbursement.unknown': 'Unknown',
  'transaction.reimbursement': 'Reimbursement',
  'transaction.reimbursement.none': 'None',
  'transaction.reimbursement.pending': 'To be reimbursed',
  'transaction.reimbursedBy': 'By whom?',
  'transaction.reimbursedByPlaceholder': 'Name or profile...',
  'profiles.title': 'Profiles',
  'profiles.empty': 'No profiles',
  'profiles.emptySubtitle': 'Add profiles to track your reimbursements.',
  'profiles.addTitle': 'New profile',
  'profiles.namePlaceholder': 'Ex: Mom, Dad, Alex...',
  'profiles.add': 'Add',
